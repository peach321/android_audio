    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnOn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String url="http://192.168.10.109:8080/darwin/service/videowall/power/on/51b33d950db04235816f04cb227d0f96";
                HttpUtil.doHttpReqeust("get", url, null, new BaseCallBack() {
                    @Override
                    public void success(Object data) {
                        Toast.makeText(AudioFxActivity.this,"success:"+data.toString(),Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void failed(int errorCode, Object data) {
                        Toast.makeText(AudioFxActivity.this,"failed:"+errorCode+data.toString(),Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        btnOff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String url="http://192.168.10.109:8080/darwin/service/videowall/power/off/51b33d950db04235816f04cb227d0f96";
                HttpUtil.doHttpReqeust("get", url, null, new BaseCallBack() {
                    @Override
                    public void success(Object data) {
                        Toast.makeText(AudioFxActivity.this,"success:"+data.toString(),Toast.LENGTH_SHORT).show();
    ...
    private void setupVisualizerFxAndUi() {
        ...
        mVisualizer.setDataCaptureListener(new OnDataCaptureListener() {
            ...
            public void onWaveFormDataCapture(Visualizer visualizer,
                ...
                //Log.i("info","waveform length:"+waveform.length);
/*                for (int i = 0; i < waveform.length; i++) {
                    Log.i("info", "waveform["+i+"]="+waveform[i]);
                    Log.i("info","samplingRate"+samplingRate);
                }*/
            }
